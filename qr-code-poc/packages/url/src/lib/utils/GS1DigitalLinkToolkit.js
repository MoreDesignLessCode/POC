...
class GS1DigitalLinkToolkit {
	...
	constructor() {
		...
		const tableS1 = {"01":{"requires":["21","235"]},"00": {"requires":null},"8006":{"requires":["21"]},"8010":{"requires":["8011"]},"8004":{"requires":null},"8003":{"minLength":15},"253":{"minLength":14},"254":{"minLength":14}}; 
		// this is incomplete but sufficient for initial testing		// TODO extend tableS1 fully.  Format is primary key : null or list of AIs of which one must be specified.
		...
		const stringSemantics = {"00":["gs1:sscc"],"01":["gs1:gtin","schema:gtin"],"10":["gs1:hasBatchLot"],"21":["gs1:hasSerialNumber"],"22":["gs1:consumerProductVariant"],"235":["gs1:hasThirdPartyControlledSerialNumber"],"253":["gs1:gdti"],"254":["gs1:hasGLNextension"],"255":["gs1:gcn"],"401":["gs1:ginc"],"402":["gs1:gsin"],"403":["gs1:routingCode"],"414":["gs1:locationGLN"],"417":["gs1:partyGLN"],"4309":["gs1:geocode"],"4320":["gs1:serviceCodeDescription"],"8003":["gs1:grai"],"8004":["gs1:giai"],"8006":["gs1:itip"],"8010":["gs1:cpid"],"8011":["gs1:hasCPIDSerialNumber"],"8013":["gs1:gmn"],"8017":["gs1:gsrnp"],"8018":["gs1:gsrn"],"8019":["gs1:srin"]};				
		
		const classSemantics = {"01":["gs1:Product","schema:Product"],"414":["gs1:Place","schema:Place"],"417":["gs1:Organization","schema:Organization"],"00":["gs1:LogisticUnit"],"253":["gs1:Document", "foaf:Document", "schema:CreativeWork"],"255":["gs1:Coupon"],"401":["gs1:Consignment"],"402":["gs1:Shipment"],"8003":["gs1:ReturnableAsset"],"8004":["gs1:IndividualAsset"],"8006":["gs1:IndividualTradeItemPiece","gs1:Product","schema:Product"],"8010":["gs1:Component"],"8013":["gs1:ProductModel"],"8017":["gs1:ServiceProvider"],"8018":["gs1:ServiceRecipient"],"8019":["gs1:ServiceInstance"]};		

		const dateSemantics = {"11":["gs1:productionDate"], "12":["gs1:dueDate"], "13":["gs1:packagingDate"], "15":["gs1:bestBeforeDate"], "16": ["gs1:sellByDate"], "17":["gs1:expirationDate"],"4326":["gs1:releaseDate"],"7006":["gs1:firstFreezeDate"]};

		const dateTimeHoursSemantics = {"4324":["gs1:deliverNotBeforeDateTime"],"4325":["gs1:deliverNotAfterDateTime"]};
...
//		}
	...
	analyseURIsemantics(gs1DigitalLinkURI) {
		...
		// console.log("Line 802 rv="+JSON.stringify(rv));
		...
		if ((relevantPathComponents.length > 0) && ((relevantPathComponents.length % 2) == 0)) {
			if (this.aiRegex[numericPrimaryIdentifier].test(decodeURIComponent(relevantPathComponents[1]))) {
				...
				if (extended) {
					...
					// console.log("structuredArray="+JSON.stringify(structuredArray));
