...
class _AdScreenState extends State<AdScreen> {
  ...
  void _showRewardedAds() {
    ...
    analytics.logEvent(
        name: 'reward Ad clicked',
        parameters: <String, dynamic>{'counter_value': _rewardCounter});
    rewardedAd.show(
  ...
  void _showInterstatialAd() {
    ...
    analytics.setAnalyticsCollectionEnabled(true);
    analytics.logEvent(
        name: 'interstial Ad clicked',
        parameters: <String, dynamic>{'counter_value': _interstitialCounter});
    interstitialAd.show();
  }
