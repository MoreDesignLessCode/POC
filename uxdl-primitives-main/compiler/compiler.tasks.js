...
const optionDefinitions = [
  { name: 'elements', alias: 'e', type: String, multiple: true },
  {
    ...
    defaultValue: ['react', 'svelte', 'vue']
      // TODO fix webcomponents manifest
      // TODO fix angular since dot-notation isn't supported
      // TODO fix preact (event.target.value) value is not a property
  },
